...
import { FileUp, Download, CheckCircle2, AlertTriangle, PenTool, Eraser, Settings2, Loader2, Image as ImageIcon, Move, ExternalLink } from 'lucide-react';
  ...
  const handleDownload = async () => {
    if (resultPdfBlob) {
      await saveOrShareFile({
        ...
        title: `Signed_${file?.name || 'document.pdf'}`,
      });
